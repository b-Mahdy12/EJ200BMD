...
*/
  ...
  // fSipmXLogical = new G4LogicalVolume(SiPM, silicon, "SiPMLogical_top");
  // fSipmYLogical = new G4LogicalVolume(SiPM, silicon, "SiPMLogical_bottom");
  ...
  Checking overlaps for volume SiPM_x ... 
-------- WWWW ------- G4Exception-START -------- WWWW -------
*** G4Exception : GeomVol1002
      issued by : G4PVPlacement::CheckOverlaps()
Overlap with volume already placed !
          Overlap is detected for volume SiPM_x:0
          with WLS_x:0 volume's
          local point (61.1349,0.169355,1.5474), overlapping by at least://! 3.8531 Ang
NOTE: Reached maximum fixed number -1- of overlaps reports for this volume !
*** This is just a warning message. ***
-------- WWWW -------- G4Exception-END --------- WWWW -------

Checking overlaps for volume SiPM_y ... 
-------- WWWW ------- G4Exception-START -------- WWWW -------
*** G4Exception : GeomVol1002
      issued by : G4PVPlacement::CheckOverlaps()
Overlap with volume already placed !
          Overlap is detected for volume SiPM_y:0
          with WLS_y:0 volume's
          local point (323.52,0.010469,0.905984), overlapping by at least: //!52739.1 fm 
NOTE: Reached maximum fixed number -1- of overlaps reports for this volume !
*** This is just a warning message. ***
-------- WWWW -------- G4Exception-END --------- WWWW -------
...
*/
  ...
  fSipmXLogical->SetVisAttributes(cyancol);
...
void DetectorConstruction::ConstructSDandField()
{
  ...
  // SensitiveDetector
  //
  SenDet *SDlogicalvolume = new SenDet(SDname = "/Detector/SiPM_top");
  G4SDManager::GetSDMpointer()->AddNewDetector(SDlogicalvolume);
  // fSipmXLogical->SetSensitiveDetector(SiPM_top);
  ...
  // fSipmYLogical->SetSensitiveDetector(SiPM_bottom);
}
